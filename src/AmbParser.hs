...
happyExpList = Happy_Data_Array.listArray (0,28) ([33072,12297,0,38912,768,12326,5633,0,0,0
	])
...
happyReduction_3 (HappyTerminal (TNumber happy_var_1))
	 =  HappyAbsSyn4
		 (Number happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	TVar happy_dollar_dollar -> cont 6;
	TAdd -> cont 7;
	TMul -> cont 8;
	TLParen -> cont 9;
	TRParen -> cont 10;
