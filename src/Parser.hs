...
happyExpList = Happy_Data_Array.listArray (0,24) ([1216,152,4,1,0,304,0,38913,8192,608,0,0,0,0
	])
...
happyReduction_5 (HappyTerminal (TNumber happy_var_1))
	 =  HappyAbsSyn6
		 (Number happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	case tk of {
	TNumber happy_dollar_dollar -> cont 7;
